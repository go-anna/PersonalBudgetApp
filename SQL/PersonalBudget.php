...
<body>
	<header>
		...
		<div class="offset-md-2 col-lg-8 offset-md-2 text-body wpis">
			...
			<h3 class="h2 text-md-left text-center">Do you have trouble managing your finances?<br><br>
			I have a solution to your problems.<br>
			Please try my application.<br></h3>
